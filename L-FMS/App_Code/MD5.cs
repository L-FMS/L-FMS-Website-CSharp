...
namespace L_FMS
{
    public class MD5
    {
        ...
        private static string EncryptWithType(string sMessage,int Itype)
        {
            string MD5 = "";
        ...
        public static string Encrypt(string sMessage){
            return EncryptWithType(sMessage, 1);
        }

        public static string EncryptMD5WithRule(string sMessage)
        {
            return EncryptWithType(sMessage, 0);
        }
    }
}